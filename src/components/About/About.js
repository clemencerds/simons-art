    ...
    return(
        <div className='About'>
            ...
            <div className='aboutcontent'>
                ...
                <br/>Now 38, married and living in Hamburg, Simon continues his artistic journey with sincerity and curiosity. Each canvas is for him a way to share his perspective on the world and to invite others to pause and contemplate.</p>
